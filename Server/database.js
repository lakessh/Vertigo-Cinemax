...
exports.addMovie = (moviedata, callback) => {
  ...
  moviedata.like = 0;
  moviedata.dislike = 0;
  var newMovie = new Movie({ id: moviedata.id, title: moviedata.title, original_title: moviedata.original_title,
                 status: moviedata.status, revenue: moviedata.revenue, overview: moviedata.overview, original_language: moviedata.original_language,
                 poster_path: moviedata.poster_path, release_date:moviedata.release_date
  });
